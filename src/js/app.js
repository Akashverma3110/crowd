App = {
  ...
  viewBalance :async () =>{
    var bala=await App.crowd.total();
    var b=bala/1000000000000000000;
    $("#balance").html(b);
    },
    register :async () =>{
      await App.crowd.registerNeedy({from:App.account})
    },
donate:async () => {
  var a=$("#amount").val()
  var amount=parseFloat(a)
  var amountwei=amount*1000000000000000000;
  await App.crowd.donate({from:App.account,value:amountwei})
